...
function initSearchBox() {
	...
	searchBox.addListener('places_changed', function() {
		...
		places.forEach(function(place) {
			...
			let infoWindow = createInfoWindow(place, markerLib.getMarkerId(newMarker));
 ...
 * @param {Object}	place			The place with the necessary information for the InfoWindow. 
 ...
 */
function createInfoWindow(place, markerId, customMaxWidth) {
	...
	return new google.maps.InfoWindow({
		content: '<div id="content">' +
			...
			'<div id="bodyContent">' +
			'<b>Name:</b> <p>' + place.name + '</p>' +
			'<b>Locatoin Types:</b> <p>' + place.types + '</p>' +
			'<b>Formatted Address: </b> <p>' + place.formatted_address + '</p>' +
