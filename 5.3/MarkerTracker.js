...
class MarkerTracker extends PrivateNameSpace{
     ...
     * @param       {Marker}    marker  The marker to associate with the information.
     ...
     * @param       {Marker}    marker              The marker object to receive the listener.
     ...
     * @param       {Function}  listenerFunction    The listener function to be executed when the marker is subject to an event.
     * @returns     {Boolean}   <code>true</code> if the association was successfl, <code>false</code> otherwise.
     ...
     * @param       {Marker}    marker  The marker whose information we want.
    ...
    /**
     * @description Returns the number of markers currently being tracked by the system. 
    ...
    /**
     * @description Returns the last TrackerId used for a marker. TrackerIds are unique and never repeat, even when the markers using them are removed from the system. TrackerIds are not recyclable and thus can also be used as marker global identifiers.
